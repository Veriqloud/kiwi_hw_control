...
def set_photons_number(N):
    ...
    att_db = np.array([
        34.696, 34.587, 34.369, 34.032, 33.581, 33.012,
        32.304, 31.479, 30.491, 29.344, 28.050, 26.591,
        24.986, 23.249, 21.368, 19.371, 17.187, 14.897,
        12.512, 10.095, 7.711, 5.485, 3.522, 1.948,
        0.893, 0.493
    ])
