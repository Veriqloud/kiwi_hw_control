...
rsync -v hw_control_alice.py $Alice:~/qline/bin/hw.py
#rsync -v ../gc/target/release/gc_client ../gc/target/release/gc_control ../gc/target/release/qber_client $Alice:~/qline/hw_control/
...
rsync -v hw_control_bob.py $Bob:~/qline/bin/hw.py
